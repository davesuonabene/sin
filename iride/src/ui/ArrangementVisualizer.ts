...
export class ArrangementVisualizer {
    ...
    private handleClick = (event: MouseEvent) => {
        ...
        if (existingIndex !== -1) {
            ...
            if (nextSampleStart.length > existingIndex + 1) nextSampleStart.splice(existingIndex + 1, 1);
            ...
            nextSampleStart.splice(splitSection + 1, 0, nextSampleStart[splitSection] ?? 0.0);
        ...
        this.options.onSectionStructureChange([...nextPoints], [...nextEnabled], [...nextProb], [...nextSampleStart], [...nextQuant], [...nextAnchor]);
